...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/js/jquery-3.3.1.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/statics/js/public.js"></script>
</head>
<body>
	<!--头部-->
	<div class="head" style="width: 100%" id="page_head">
		...
		<div class="logo_bg">
			...
			<script type="text/javascript"
				src="${pageContext.request.contextPath }/statics/js/banner.js"></script>
		</div>
		<!--引入尾部共同部分  -->
