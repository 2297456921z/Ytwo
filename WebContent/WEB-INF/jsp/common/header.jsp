...
<!--LOGO-->
		<div class="top_bg">
			<div class="top">
				<div class="top_left">
					<div class="top_l1">
						<a href="" target="_blank"><img src="${pageContext.request.contextPath}/statics/images/top_1.png" />手机版</a><span>|</span>
					</div>
					<div class="top_l2">
						<a href="" target="_blank"><img src="${pageContext.request.contextPath }/statics/images/top_2.png" />武汉</a><span><a
							href="" target="_blank">天津</a><a href="" target="_blank">[更多]</a></span>
					</div>
				</div>
				<div class="top_right">
					<div class="top_r1">
						<a id="getButton" href="${pageContext.request.contextPath}/login" target="_self">登录</a> <a
			...
			<div class="logo">
				...
				<div class="logo_nav yahei">
					<ul>
						...
						<li class="nav_now"><a href="${pageContext.request.contextPath }/index" target="_blank">首页</a></li>
					</ul>
					</div>
					</div>
		</div>
